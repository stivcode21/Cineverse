          ...
          <div className="z-40 px-6 md:px-16 mt-6 flex absolute top-0 left-0">
            ...
            <div className="flex flex-col gap-4 w-full">
              ...
              <div className="flex gap-4 text-lg font-semibold text-white">
                <p className="bg-slate-800 px-2 rounded-md text-gray-300 text-[16px]">{`Temporadas: ${serie.number_of_seasons}`}</p>
                <p className="bg-slate-800 px-2 rounded-md text-gray-300 text-[16px]">{`Capitulos: ${serie.number_of_episodes}`}</p>
                <p className="">{`( ${year} )`}</p>
              </div>
              <p className="text-white text-md">{serie.overview}</p>
              {/* buttons */}
