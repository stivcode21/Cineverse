    ...
    return (
        <nav className='fixed top-0 left-0 right-0 z-50 bg-black'>
            <div className='flex flex-wrap items-center justify-end md:justify-center w-full px-8 md:px-16 py-2'>
                <a href={"#main"} className='text-white text-3xl font-logo md:text-4x'>
                </a>
                {/* Menu de navegacion en Mobile mediante botton */}
                <div className='mobile-menu md:hidden flex justify-between items-center w-full'>
                    <div className="relative group w-11 border-2">
                        <img src="https://i.imgur.com/pfNi87l_d.webp?maxwidth=640&shape=thumb&fidelity=medium" alt="logo" />
                    ...
                    <h1 className="text-4xl font-bold text-blue-500" style={{ fontFamily: 'Bebas Neue' }}>
                        cineverse
                    </h1>
                    {
                ...
                <div className='menu hidden md:block md:w-full' id='navbar'>
                    <ul className='flex md:flex-row justify-center md:space-x-8 relative mt-0'>
                        <li className="flex items-center">
                            <h1 className="text-4xl font-bold absolute left-0 text-blue-500" style={{ fontFamily: 'Bebas Neue' }}>
                                cineverse
                            </h1>
                        </li>
                        {
                        ...
                        <li className="group absolute right-0 w-11 border-2">
